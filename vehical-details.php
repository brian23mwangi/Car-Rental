...
<body>
  ...
  <!--car lisiting mercedes, nissan seen in the slider -->
  <?php
              ...
              <div class="sidebar_widget">
                ...
                <form method="post">
                  <div class="form-group">
                    ...
                    <input type="date" id="date_picker" class="form-control" name="fromdate" placeholder="From Date" required>
                  </div>
                  <div class="form-group">
                    <label>To Date:</label>
                    <input type="date" id="date_pick" class="form-control" name="todate" placeholder="To Date" required>
                  </div>
                  <div class="form-group">
