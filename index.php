  ...
  <section class="section-padding gray-bg">
    <div class="container">
      <div class="section-header text-center">
        ...
        <p>Visit our showroom today to explore our new car selection and take advantage of exclusive offers and financing options. We are committed to ensuring that your car buying experience is seamless and enjoyable. Our knowledgeable staff is ready to answer any questions you may have and guide you through the process of selecting your new vehicle.</p>
      </div>
      <div class="video-container">
        <video controls>
          <source src="./assets/images/car.mp4">
        </video>
      </div>
      <div class="row">
        ...
        <div class="tab-content">
          <div role="tabpanel" class="tab-pane active" id="resentnewcar">
            <!--car listing in the index page, mercedes, nissan -->
            ...
            ?>
                <!--fetches cars from the database of tblvehichles and tblbrands-->
